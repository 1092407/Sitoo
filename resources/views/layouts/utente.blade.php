...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <title>blo | @yield('title', 'utente')</title>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
            ...
            <div class="w3-display-middle" style="white-space:nowrap;">
              <span class="logo w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">BENTORNATO NELLA TUA AREA RISERVATA </span>
            </div>
        </div>
