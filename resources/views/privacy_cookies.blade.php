...
@section('title', 'Privacy e Cookie Policy')

@section('content')
<div class="w3-container w3-padding-32" id="privacy">
    <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16" align="center"><b>Privacy e Cookie Policy</b></h2>
    <h4 class="w3-border-bottom w3-border-light-grey w3-padding-16"><b>Tipologie di Dati raccolti</b></h4>
    <p>Fra i Dati Personali raccolti da questo Sito Web, in modo autonomo o tramite terze parti, ci sono: Cookie; Dati di utilizzo.<br>
    ...
    <h4 class="w3-border-bottom w3-border-light-grey w3-padding-16"><b>Modalità e luogo del trattamento dei Dati raccolti</b></h4>
    <p>
    ...
    <h4 class="w3-border-bottom w3-border-light-grey w3-padding-16"><b>Finalità del Trattamento dei Dati raccolti</b></h4>
    <p>I Dati dell’Utente sono raccolti per consentire al Titolare di fornire il Servizio, adempiere agli obblighi di legge, rispondere a richieste o azioni esecutive, tutelare i propri diritti ed interessi (o quelli di Utenti o di terze parti), individuare eventuali attività dolose o fraudolente, nonché per le seguenti finalità: Statistica, Remarketing e behavioral targeting, Gestione dei tag e Test di performance di contenuti e funzionalità (A/B testing).</p>
    <p>Per ottenere informazioni dettagliate sulle finalità del trattamento e sui Dati Personali trattati per ciascuna finalità, l’Utente può fare riferimento alla sezione “Dettagli sul trattamento dei Dati Personali”.</p>
    <h4 class="w3-border-bottom w3-border-light-grey w3-padding-16"><b>Cookie Policy di www.blog.it</b></h4>
